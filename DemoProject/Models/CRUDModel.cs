...
namespace DemoProject.Models
{
    public class CRUDModel
    {
        ...
        public DataTable GetAllStudents()
        {
            ...
            string strConString = "Data Source=DESKTOP-2PGL05P;Initial Catalog=MyDB;Integrated Security=True";
        ...
        public int UpdateStudent(int intStudentID, string strStudentName, string strGender, int intAge)
        {
            ...
            {
                con.Open();
                string query = "Update tblStudent SET student_name=@studname, stduent_age=@studage , student_gender=@gender where student_id=@studid";
        ...
        public int InsertStudent(string strStudentName, string strGender, int intAge)
        {
            ...
            {
                con.Open();
                string query = "Insert into tblStudent (student_name, stduent_age,student_gender) values(@studname, @studage , @gender)";
                SqlCommand cmd = new SqlCommand(query, con);
                cmd.Parameters.AddWithValue("@studname", strStudentName);
                cmd.Parameters.AddWithValue("@studage", intAge);
                cmd.Parameters.AddWithValue("@gender", strGender);
